## Rebuttal
	...
	- ### Response to GVKf
		...
		- **Equation 272–274 typo.** Thank you for pointing out the issue. This is indeed a typo. First, the actual implementation is based on autodiff of the loss $\ell_\text{priv}(x,y)$ and thus our results are unaffected.
		-
- ## Reviews
	- ### Reviewer_AkJH
	  collapsed:: true
