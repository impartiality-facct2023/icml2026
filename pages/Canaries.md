## Rebuttal
	- ### Response to AkJH {{renderer :wordcountchar_}}
		...
		- **We do not propose a new MIA evaluation or attack.** The canaries that we produce are in the input space, and as a result can be used in any membership inference
		-
- ## Reviews
	- ### Reviewer_AkJH
