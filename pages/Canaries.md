## Rebuttal
	...
	- ### Response to GVKf {{renderer :wordcountchar_}}
		...
		- **Logit rescaling in Lines 188-219.** We explain two steps in this section. The critical step is logit re-scaling which is explained in detail in the original LiRA paper (Carlini et al. 2021). The necessity of this step is best explained in the context of the the hypothesis test and its statistic in Eq.3. Similar to LiRA, any empirical measurement
- ## Reviews
	- ### Reviewer_AkJH
	  collapsed:: true
