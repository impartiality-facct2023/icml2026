## Rebuttal
	...
	- ### Response to AkJH {{renderer :wordcountchar_}}
		...
		- We can establish a formal connection between Influence Optimized baseline and gradient matching; whose details we are happy to discuss . The key insight is discussed at length in Appendix B (Lines 811–846).
		-
		-
- ## Reviews
	- ### Reviewer_AkJH
